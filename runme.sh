...
arch-chroot /mnt /bin/bash -c "pacman --noconfirm -Rcs vim openvpn emacs-nox lvm2 tango-icon-theme xorg-xmessage xf86-input-evdev xf86-input-synaptics zd1211-firmware"
