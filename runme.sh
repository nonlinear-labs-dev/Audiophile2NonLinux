...
arch-chroot /mnt /bin/bash -c "pacman --noconfirm -Rcs vim openvpn emacs-nox lvm2 tango-icon-theme xorg-xmessage"
arch-chroot /mnt /bin/bash -c "pacman --noconfirm -Rcs xf86-input-evdev xf86-input-synaptics zd1211-firmware"
arch-chroot /mnt /bin/bash -c "yes | pacman --noconfirm -S cpupower git networkmanager"
